...
########### t1 ########### 
        ...
        if i >0:
            systUp[sub_a(i, j),sub_b(i-1, j)] = t1
            systUp[sub_d(i, j),sub_c(i-1, j)] = t1
            systDw[sub_a(i, j),sub_b(i-1, j)] = t1
            systDw[sub_d(i, j),sub_c(i-1, j)] = t1
########### t1 ########### 
########### t2 ########### 
        systUp[sub_c(i, j),sub_b(i, j)] = t2 
        systDw[sub_c(i, j),sub_b(i, j)] = t2 
        if j >0:
            systUp[sub_a(i, j),sub_d(i, j-1)] = t2
            systDw[sub_a(i, j),sub_d(i, j-1)] = t2
########### t2 ########### 
########### t3 ########### 
        if i >0 and j>0:
        ...
        if j >0:
            systUp[sub_a(i, j),sub_b(i,j-1)] = t3
            systDw[sub_a(i, j),sub_b(i,j-1)] = t3
        if i >0 and j>0:
            systUp[sub_d(i,j-1),sub_c(i-1,j)] = t3            
            systDw[sub_d(i,j-1),sub_c(i-1,j)] = t3            
        if j >0:
            systUp[sub_c(i, j),sub_d(i,j-1)] = t3
            systDw[sub_c(i, j),sub_d(i,j-1)] = t3
########### t3 ########### 
########### t4 ###########
        ...
        if i >0:
            ...
            systUp[sub_b(i-1, j),sub_d(i, j)] = t4
            systDw[sub_b(i-1, j),sub_d(i, j)] = t4
        if j >0:
            systUp[sub_c(i, j-1),sub_a(i, j)] = t4
            systDw[sub_c(i, j-1),sub_a(i, j)] = t4
            systUp[sub_d(i, j-1),sub_b(i, j)] = t4
            systDw[sub_d(i, j-1),sub_b(i, j)] = t4
        if i*j >0:
            systUp[sub_a(i-1, j-1),sub_c(i, j)] = t4
            systDw[sub_a(i-1, j-1),sub_c(i, j)] = t4
            systUp[sub_d(i, j-1),sub_b(i-1, j)] = t4
            systDw[sub_d(i, j-1),sub_b(i-1, j)] = t4
########### t4 ########### 
########### t5 ########### 
        systUp[sub_d(i, j),sub_a(i, j)] = t5
        systDw[sub_d(i, j),sub_a(i, j)] = t5
        if j>0:
            systUp[sub_b(i, j),sub_c(i, j-1)] = t5
            systDw[sub_b(i, j),sub_c(i, j-1)] = t5
########### t5 ########### 
...
########### t1 ########### 
        ...
        if i >0:
            left_leadUp[sub_a(i, j),sub_b(i-1, j)] = t1  
            left_leadDw[sub_a(i, j),sub_b(i-1, j)] = t1  
            left_leadUp[sub_d(i, j),sub_c(i-1, j)] = t1  
            left_leadDw[sub_d(i, j),sub_c(i-1, j)] = t1  
########### t1 ########### 
########### t2 ########### 
        left_leadUp[sub_c(i, j),sub_b(i, j)] = t2
        left_leadDw[sub_c(i, j),sub_b(i, j)] = t2
        if j >0:
            left_leadUp[sub_a(i, j),sub_d(i, j-1)] = t2
            left_leadDw[sub_a(i, j),sub_d(i, j-1)] = t2
########### t2 ########### 
########### t3 ########### 
        if i >0 and j>0:
        ...
        if j >0:
            left_leadUp[sub_a(i, j),sub_b(i,j-1)] = t3
            left_leadDw[sub_a(i, j),sub_b(i,j-1)] = t3
        if i >0 and j>0:
            left_leadUp[sub_d(i,j-1),sub_c(i-1,j)] = t3            
            left_leadDw[sub_d(i,j-1),sub_c(i-1,j)] = t3            
        if j >0:
            left_leadUp[sub_c(i, j),sub_d(i,j-1)] = t3
            left_leadDw[sub_c(i, j),sub_d(i,j-1)] = t3
########### t3 ########### 
########### t4 ###########
        ...
        if i >0:
            ...
            left_leadUp[sub_b(i-1, j),sub_d(i, j)] = t4
            left_leadDw[sub_b(i-1, j),sub_d(i, j)] = t4
        if j >0:
            left_leadUp[sub_c(i, j-1),sub_a(i, j)] = t4
            left_leadDw[sub_c(i, j-1),sub_a(i, j)] = t4
            left_leadUp[sub_d(i, j-1),sub_b(i, j)] = t4
            left_leadDw[sub_d(i, j-1),sub_b(i, j)] = t4
        if i*j >0:
            left_leadUp[sub_a(i-1, j-1),sub_c(i, j)] = t4
            left_leadDw[sub_a(i-1, j-1),sub_c(i, j)] = t4
            left_leadUp[sub_d(i, j-1),sub_b(i-1, j)] = t4
            left_leadDw[sub_d(i, j-1),sub_b(i-1, j)] = t4
########### t4 ########### 
########### t5 ########### 
        left_leadUp[sub_d(i, j),sub_a(i, j)] = t5
        left_leadDw[sub_d(i, j),sub_a(i, j)] = t5
        if j>0:
            left_leadUp[sub_b(i, j),sub_c(i, j-1)] = t5
            left_leadDw[sub_b(i, j),sub_c(i, j-1)] = t5
########### t5 ########### 
...
ax1.set_ylim(-3,3)
ax1.set_xlim(-1,1)
pyplot.savefig("ZigZagSpin.png", dpi=300)
